...
![alt text](airflow_images/create-connection.PNG)
...
![connection-aws](airflow_images/connection-aws-credentials.PNG)
...
![alt text](airflow_images/cluster-details.PNG)
You are all configured to run Airflow with Redshift.
![alt text](airflow_images/connection-redshift.PNG)
